...
def parse_args():
    ...
    parser.add_argument(
        "--modelpath",
        type=str,
        default="/content/data/ISTD_params_0600000.pt",
        help="model_path",
    )
    parser.add_argument(
        "--datasetpath",
        type=str,
        default="/disk1/yeying/dataset/SRD",
        help="dataset_path",
    )
    parser.add_argument(
        "--iteration",
    ...
    parser.add_argument(
        "--write_files", type=str2bool, default=True, help="Write result files"
    )
    ...
    parser.add_argument(
        "--dom_weight", type=int, default=1, help="Weight for domain classification"
    )
    parser.add_argument(
        "--ch_weight", type=int, default=1, help="Weight for shadow-free chromaticity"
    )
    parser.add_argument(
        "--pecp_weight", type=int, default=1, help="Weight for shadow-robust feature"
    )
    parser.add_argument(
        "--smooth_weight", type=int, default=1, help="Weight for boundary smoothness"
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="use crop mode instead bordering",
    )
    parser.add_argument(
        "--use_ch_loss",
        type=str2bool,
        default=True,
        help="use shadow-free chromaticity loss",
    )
    parser.add_argument(
        "--use_pecp_loss",
        type=str2bool,
        default=True,
        help="use shadow-robust feature loss",
    )
    parser.add_argument(
        "--use_smooth_loss",
        type=str2bool,
        default=True,
        help="use boundary smoothness loss",
    )
